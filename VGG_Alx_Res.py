...
if __name__ == '__main__':
    ...
    # InceptionV3
    # model = transfer.InceptionV3_model(nb_classes=3, img_rows=image_size, img_cols=image_size, is_plot_model=True)
...
# 应用Grad-CAM算法
dendrobium_huoshanense_output = model.output[:, 108]
